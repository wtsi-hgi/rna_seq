process 'star_2pass_2nd_pass' {
    ...
    publishDir "${params.outdir}/star_pass2_2ndpass/$samplename", mode: "${params.copy_mode}", overwrite: true, pattern: "*Unmapped.out.mate2"
  ...
  output:
    ...
    file "*.SJ.out.tab"
    tuple val(samplename), file("*Unmapped.out.mate1"), file ("*Unmapped.out.mate2") //into star_aligned
